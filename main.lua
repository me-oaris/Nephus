...
do
    ...
    Tabs.Misc:AddButton({
        ...
        Callback = function()
            ...
            local response, statusCode, _, _ = http.request(robloxApiUrl)
            ...
            if statusCode == 200 then
                ...
                if statusCode == 200 then
                    ...
                    print("Failed to send webhook message. Status code:", statusCode)
                end
            else
                print("Failed to fetch Roblox user data. Status code:", statusCode)
            end
        end
    })
